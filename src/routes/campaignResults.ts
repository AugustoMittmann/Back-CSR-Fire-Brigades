...
export const campaignResultsRouter = (): Router => {
  ...
  r.post('/', requireAuth, asyncHandler(campaignResults.create));
  r.put('/:id', requireAuth, asyncHandler(campaignResults.update));
  r.delete('/:id', requireAuth, asyncHandler(campaignResults.remove));
  return r;
};
